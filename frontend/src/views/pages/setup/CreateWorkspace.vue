...
<template>
    <div class="max-w-4xl mx-auto p-6">
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-surface-900 dark:text-surface-0">Create Your Workspace</h1>
            <p class="text-surface-600 dark:text-surface-400 mt-2">Let's set up your AI Customer Support environment</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <template #content>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <InputText v-model="form.name" class="w-full" :class="{ 'p-invalid': getError('name') }" placeholder="Enter workspace name" />
                        ...
                        <div>
                            ...
                            <Select v-model="form.timezone" :options="timezones" optionLabel="label" optionValue="value" placeholder="Select Timezone" class="w-full" :class="{ 'p-invalid': getError('timezone') }" />
                ...
                <template #content>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <InputText v-model="form.support_email" type="email" class="w-full" :class="{ 'p-invalid': getError('support_email') }" placeholder="support@example.com" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <Select v-model="form.default_language" :options="languages" optionLabel="label" optionValue="value" placeholder="Select Language" class="w-full" :class="{ 'p-invalid': getError('default_language') }" />
            ...
            <div class="flex justify-end gap-3 pt-4">
                <Button type="submit" :label="saving ? 'Creating...' : 'Create Workspace'" severity="primary" :loading="saving" :disabled="saving" icon="pi pi-save" />
            </div>
        </form>
    </div>
</template>
