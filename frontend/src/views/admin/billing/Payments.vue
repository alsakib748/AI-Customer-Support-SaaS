...
<template>
    <div class="p-6">
        ...
        <div class="mb-4 flex flex-wrap gap-3 items-center">
            ...
            <div class="w-48">
                <Select v-model="filters.provider" :options="providerOptions" optionLabel="label" optionValue="value" placeholder="Provider" class="w-full" @change="load" clearable />
            </div>
        </div>

        <DataTable :value="payments" :loading="loading" paginator :rows="filters.per_page" :totalRecords="total" :lazy="true" @page="onPageChange" class="w-full">
        ...
        <Dialog v-model:visible="showRefundDialog" header="Refund Payment" :style="{ width: '450px' }" modal>
            <div class="space-y-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <small class="text-surface-500"> Refundable: {{ formatCurrency(selectedPayment?.amount - selectedPayment?.refunded_amount) }} </small>
                </div>
                <div class="flex flex-col gap-2">
