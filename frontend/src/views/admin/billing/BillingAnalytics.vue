        ...
        <div v-else-if="analytics" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <template #content>
                        <ul class="space-y-3">
                            <li class="flex justify-between">
                                ...
                                <span class="font-bold text-success">{{ formatCurrency(analytics.revenue_last_30_days)
                                    }}</span>
                            </li>
                            <li class="flex justify-between">
                                <span>MRR</span>
                ...
                <Card>
                    ...
                    <template #content>
                        <ul class="space-y-3">
                            <li class="flex justify-between"><span>Active</span><span class="font-bold text-success">{{
                                analytics.active_subscriptions }}</span></li>
                            <li class="flex justify-between"><span>Trialing</span><span class="font-bold text-info">{{
            ...
            <Card>
                ...
                <template #content>
                    <div class="space-y-3">
                        <div v-for="plan in analytics.plan_distribution" :key="plan.plan_id"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="w-32 bg-surface-200 dark:bg-surface-700 rounded-full h-2">
                                    <div class="bg-primary h-2 rounded-full"
                                        :style="{ width: (plan.count / Math.max(...analytics.plan_distribution.map(p => p.count), 1) * 100) + '%' }">
                                    </div>
                                </div>
                            </div>
                        </div>
