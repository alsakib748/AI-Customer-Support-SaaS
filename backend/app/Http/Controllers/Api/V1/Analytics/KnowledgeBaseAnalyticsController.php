...
use App\Services\Analytics\KnowledgeBaseAnalyticsService;
...
class KnowledgeBaseAnalyticsController extends Controller
{
    public function __construct(
        protected KnowledgeBaseAnalyticsService $service
    ) {
    }
    ...
    {
        try {
            // $this->authorizeAnalytics('analytics.knowledge_base');
            ...
            Log::error('Knowledge base analytics failed:', ['error' => $e->getMessage()]);
            return response()->json([
                'success' => false,
                'message' => 'Failed to load knowledge base analytics.',
            ], 500);
        }
    }
